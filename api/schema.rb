QueryRoot = GraphQL::ObjectType.define do
  ...
  field :saltedge_provider do
    ...
    resolve -> (obj, args, ctx) { SaltedgeProvider.selectable.find(args["id"]) }
  end
...
MutationRoot = GraphQL::ObjectType.define do
  ...
  field :reconnectSaltedgeLogin, field: Mutations::ReconnectSaltedgeLogin
  ...
  field :submitInteractiveFields, field: Mutations::SubmitInteractiveFields
end
